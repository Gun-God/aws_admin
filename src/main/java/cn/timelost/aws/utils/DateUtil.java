...
public class DateUtil {
     ...
     * @return String
     */
    public static String getCurrentDateStr(String fomart) {
     ...
     * @return java.util.Date
     */
    public static Date beforeHourToNowDate(Date date, int num) {
        Calendar calendar = Calendar.getInstance();
     ...
     * @return java.util.Date
     */
    public static Date afterHourToNowDate(Date date, int num) {
        Calendar calendar = Calendar.getInstance();
        /* HOUR_OF_DAY 指示一天中的小时 */
        calendar.setTime(date);
        calendar.add(Calendar.HOUR_OF_DAY, num);
    ...
    /**
     * 根据当前时间获取最近24小时的时间段时间
     * @return
     */
    public static List<Date[]> before24HByNowDate() {
    ...
    public static void main(String[] args) {
        List<Date[]> dates = before24HByNowDate();
        for (Date[] da : dates) {
            System.err.print(DateUtil.formatDate(da[0], "yyyy-MM-dd HH:mm:ss"));
            System.err.print(" -- ");
            System.err.println(DateUtil.formatDate(da[1], "yyyy-MM-dd HH:mm:ss"));
        }
