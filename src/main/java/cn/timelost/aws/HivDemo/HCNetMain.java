...
public class HCNetMain {
            ...
            synchronized (HCNetSDK.class) {
                ...
                try {
                    if (osSelect.isWindows())
                        //win系统加载库路径
                        strDllPath = System.getProperty("user.dir") + "\\libs\\hik2\\HCNetSDK.dll";
        ...
        if (playControl == null) {
            synchronized (PlayCtrl.class) {
                ...
                try {
                    if (osSelect.isWindows())
                        //win系统加载库路径
                        strPlayPath = System.getProperty("user.dir") + "\\libs\\hik2\\PlayCtrl.dll";
                    else if (osSelect.isLinux())
                        //Linux系统加载库路径
    ...
    public HCNetMain(Session session, String userName, String passWord, String deviceIP, int port) {
        ...
        login_V40(deviceIP,(short)port,userName,passWord);
...
/*
    public static void main(String[] args) throws InterruptedException {
        ...
        login_V40("192.10.12.245",(short) 8000,"admin","admin12345");
        ...
        //实时取流
        VideoDemo.realPlay(lUserID,lDChannel,session);
