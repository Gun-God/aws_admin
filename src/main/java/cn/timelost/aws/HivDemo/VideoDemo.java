...
import static cn.timelost.aws.HivDemo.HCNetMain.hCNetSDK;
import static cn.timelost.aws.HivDemo.HCNetMain.playControl;
...
public class VideoDemo {
    ...
    public static void realPlay(Session web_session, int userID, int iChannelNo) {
        if (userID == -1) {
            System.out.println("请先注册");
            return;
        }
//        session还需要进一步的处理，或者将realPlay移动到外面
